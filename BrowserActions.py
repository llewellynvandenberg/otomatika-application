...
class BrowserActions:
    ...
    def select_topic(self):
        ...
        if self.option != 'Any':
            ...
            self.driver.wait_until_page_contains_element("css:[data-testid='search-multiselect-button']", timeout=10)
            self.driver.click_button("css:[data-testid='search-multiselect-button']")
            # wait for and collect dropdown options
            self.driver.wait_until_element_is_visible("css:[data-testid='DropdownLabel']", timeout=10)
